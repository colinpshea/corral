...
#' @returns This function takes data (a vector, data frame, or matrix) and calculates the percentage of observations that are not `NA` or `NULL` values. This is used to calculate the percentage of loci with valid SNP genetic data.
#' @export
